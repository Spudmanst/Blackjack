# Blackjack version 2.4.2

import modules.playing_cards as playing_cards
import modules.text_effect as text_effect
import modules.winnings as winnings
import sys
            ...
            for player in players:
                if player.active:
                    ...
                    while player.score < 21:
                        action = text_effect.slow_input("What would you like to do, '(H)it' or '(S)tick'? ").lower()
                        ...
                        if action in ("hit", "h"):
                            ...
                            text_effect.slow_type(f"Player {player.name} is sticking with a score of {player.score}")
                            break
...
while True:
    ...
    while True:
        action = text_effect.slow_input("What would you like to do? (R)eplay, (E)xit: ").lower()
